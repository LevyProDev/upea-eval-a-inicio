...
interface DirectorDocumentUploadStepProps {
  documents: DirectorDocuments;
  onChange: (documents: DirectorDocuments) => void;
}

const DirectorDocumentUploadStep = ({
  documents,
  onChange,
}: DirectorDocumentUploadStepProps) => {
  const [errors, setErrors] = useState<Record<string, string>>({});

  const handleChange = (field: keyof DirectorDocuments, value: string) => {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {documentFields.map((field) => {
          ...
          const value = documents[field.id as keyof DirectorDocuments];
              ...
              <CardContent className="pt-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange(
                        field.id as keyof DirectorDocuments,
                        e.target.value
                      )
                    }
                    className={
...
export default DirectorDocumentUploadStep;
