...
interface AdminDocumentUploadStepProps {
  documents: AdminDocuments;
  onChange: (documents: AdminDocuments) => void;
}

const AdminDocumentUploadStep = ({
  documents,
  onChange,
}: AdminDocumentUploadStepProps) => {
  const [errors, setErrors] = useState<Record<string, string>>({});

  const handleChange = (field: keyof AdminDocuments, value: string) => {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {documentFields.map((field) => {
          ...
          const value = documents[field.id as keyof AdminDocuments];
              ...
              <CardContent className="pt-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange(
                        field.id as keyof AdminDocuments,
                        e.target.value
                      )
                    }
                    className={
...
export default AdminDocumentUploadStep;
